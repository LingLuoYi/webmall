...
?>
    ...
    <main class="main">
        <?php
        foreach ($pr->getAllBanner() as $prm){
            if ($prm->getType() == "index1"){
                echo '<a href="'.$prm->getUrl().'"><section class="banner" style="background: url('.$prm->getBannerUrl().') no-repeat center 0.05rem/100% 6.41rem #00000000;"></section></a>
';
            }
        }
        ?>
